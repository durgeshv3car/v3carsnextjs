...
interface ExpertCarReviewsProps {
    expertCarReviews: NewsItem[]
}
...
const ExpertCarReviews: React.FC<ExpertCarReviewsProps> = ({ expertCarReviews }) => {
