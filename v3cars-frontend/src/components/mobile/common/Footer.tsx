        ...
        <div className="mx-4 py-4 grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="rounded-xl border border-gray-300 dark:border-[#262629] overflow-hidden shadow-sm">
            <button
              ...
              className="w-full flex justify-between items-center bg-[#D9D8D8] dark:bg-[#262629] px-4 py-3 font-bold text-lg"
            >
              <span>Tools</span>
              {open ? (
                <BiChevronUp className="w-5 h-5 transition-transform duration-300" />
              ) : (
                <BiChevronDown className="w-5 h-5 transition-transform duration-300" />
              )}
            </button>
