...
import { useGetLatestCarGuideQuery, useGetPopularCarGuideQuery, useGetTopCarGuideQuery, useGetTrendingCarGuideQuery } from "@/redux/api/contentModuleApi";

const buttons = ['Latest Car Guide', 'Trending Car Guide', 'Top Car Guide'];

function MainCarGuideComponent() {
...
export default MainCarGuideComponent;
