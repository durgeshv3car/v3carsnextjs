...
const Footer: React.FC = () => {
  return (
    ...
    <footer className="bg-[#E2E2E2] border-t border-gray-300">
      <div className="w-[90%] xl:w-[1600px] mx-auto pt-8 pb-2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        {/* Connect */}
        <div className="space-y-6">
          <div>
            <h3 className="font-semibold text-lg text-gray-800 inline-block pb-1">Connect</h3>
            <div className="h-0.5 rounded-full bg-gradient-to-r from-black to-transparent w-full"></div>
          </div>
        ...
        <div className="space-y-6">
          <div>
            <h3 className="font-semibold text-lg inline-block text-gray-800 pb-1">Research</h3>
            <div className="h-0.5 rounded-full bg-gradient-to-r from-black to-transparent w-full"></div>
          </div>
          <ul className="text-sm text-gray-700">
            {[
              ...
              <React.Fragment key={index}>
                ...
                <div className="h-0.5 w-full rounded-full bg-gradient-to-r from-transparent via-gray-300 to-transparent" />
              </React.Fragment>
            ))}
          </ul>
        </div>
        ...
        <div className="space-y-6">
          <div className="mb-2">
            <h3 className="font-semibold text-lg inline-block text-gray-800 pb-1">Tools</h3>
            <div className="h-0.5 rounded-full bg-gradient-to-r from-black to-transparent w-full"></div>
          </div>
          <ul className="text-sm text-gray-700">
            {[
        ...
        <div className="space-y-6">
          ...
          <input
            ...
            className="w-full border border-black bg-white rounded-lg px-3 text-sm py-5"
          />
          <button className="w-full bg-black font-light text-white py-4 rounded-xl hover:bg-gray-700">
            Subscribe
          </button>
          ...
          <div className="flex flex-wrap justify-center items-center space-x-1 xl:space-x-2">
            <Link href="#" className="border-2 border-black rounded-full p-3"><FaYoutube /></Link>
            <Link href="#" className="border-2 border-black rounded-full p-3"><FaFacebookF /></Link>
            <Link href="#" className="border-2 border-black rounded-full p-3"><FaInstagram /></Link>
            <Link href="#" className="border-2 border-black rounded-full p-3"><FaLinkedinIn /></Link>
            <Link href="#" className="border-2 border-black rounded-full p-3"><RiTwitterXFill /></Link>
      ...
      <div className="bg-yellow-400 text-sm py-6 text-center">
        <div className="w-[90%] xl:w-[1600px] mx-auto flex flex-col md:flex-row justify-between items-center">
          <span>Copyright 2024 V3Cars</span>
