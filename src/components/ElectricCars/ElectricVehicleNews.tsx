...
const ElectricVehicleNews: React.FC = () => {
            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <div className="flex items-center justify-between w-full lg:w-auto gap-4">
                        <h2 className="text-lg font-medium">Electric Vehicle (EV) News Update</h2>
                        <Link
                            href="#"
                            className="text-[#FFCC00] font-medium text-sm hover:underline flex gap-2 items-center"
                        >
                            View All EV News Update
                            <svg
                ...
                <div className="flex space-x-2 overflow-x-auto scroll-smooth scrollbar-hide" ref={scrollRef}>
                    {newsList.map((item) => (
                        <div
                            key={item.id}
                            className="bg-white rounded-lg min-w-[390px] min-h-[371px] shadow-sm overflow-hidden hover:shadow-md transition p-3 flex flex-col space-y-4"
                        >
                            {/* Fixed height image */}
...
export default ElectricVehicleNews;