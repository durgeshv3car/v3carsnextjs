...
const CarListCard: React.FC<CarProps> = ({ name, price, mileage, engine, fuel, seats, image }) => {
    return (
        <div className="border rounded-xl min-h-[232px] shadow-sm flex gap-4 p-2">
            ...
            <div className="w-full flex flex-col flex-shrink">
                ...
                <div className="mt-2 flex justify-between border-t h-full flex-grow">
                    ...
                    <div className="flex items-center gap-4">
                        <button className="bg-yellow-400 text-sm font-medium w-[150px] h-8 rounded-md">View Details</button>
                        <button className="bg-yellow-400 text-sm font-medium w-[150px] h-8 rounded-md">Get On Road Price</button>
                    </div>
                </div>
            </div>
        </div>
