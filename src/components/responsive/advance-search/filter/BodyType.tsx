...
const BodyTypeFilter = ({ openSection, toggleSection }: BodyFilterProps) => {
    ...
    return (
        <div className="pt-3">
            ...
            >
                <h3 className="font-semibold text-lg">Body Type</h3>
                <div className={`${openSection === 'body' ? "rotate-180" : "rotate-0"} transition-transform duration-300`}>
                    <svg
