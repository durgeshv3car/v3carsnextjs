                ...
                <div className="bg-white p-2 rounded-xl">
                    <ResponsiveContainer width="100%" height={600}>
                        <BarChart data={data} margin={{ top: 20, right: 30, left: 0, bottom: 30 }}>
                            ...
                            <XAxis dataKey="name" label={{ value: 'Regions by feature property value', position: 'bottom', offset: 10, fontWeight: 600 }} />
                            <YAxis label={{ value: 'Series reduction value', angle: -90, position: 'insideLeft', fontWeight: 600 }} />
                            <Tooltip />
