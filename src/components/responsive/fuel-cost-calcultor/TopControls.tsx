...
export default function TopControls({
  ...
  return (
    <div className="relative z-0 bg-white">{/* ensure this stack is below header */}
      {/* skyline */}
      <Image
      ...
      <div className="absolute inset-x-0 bottom-0 z-10">
        <div className="w-full  text-white">
          <div className="max-w-[1600px] mx-auto px-4">
            ...
            <div className="shrink-0 rounded-t-xl px-4 py-3 min-w-[240px] mr-4 bg-black w-[10%]">
          ...
          <div className="w-full bg-[#0b0d10]">
            <div className="max-w-[1600px] mx-auto px-4 flex items-stretch gap-0 px-3 md:px-4 py-3 overflow-x-auto space-x-28">
              <div className="w-[10%]">
