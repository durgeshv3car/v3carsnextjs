...
const WebStoryCard: FC = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-[#495463] to-[#6b775b]">
            <div className="relative w-full lg:w-[500px] h-screen lg:h-[800px] rounded-none lg:rounded-2xl overflow-hidden shadow-xl">
                {/* Progress Bars */}
                <div className="absolute top-2 left-2 right-2 flex gap-1 z-20">
                    {stories.map((_, i) => (
                        <div key={i} className="flex-1 h-[2px] rounded-full bg-white/40 overflow-hidden">
                            <div
                ...
                <div className="absolute top-6 right-4 z-20 flex gap-4">
                    ...
                    <button onClick={() => setIsPlaying(!isPlaying)}>
                        {isPlaying ? (
                            <svg xmlns="http://www.w3.org/2000/svg" className="size-6 text-white" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor">
                    ...
                    <button onClick={handleShare}>
                        <svg xmlns="http://www.w3.org/2000/svg" className="size-5 text-white" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor">
                ...
                {/* Image */}
                <img src={story.image} alt="Web Story" className="w-full h-full object-cover" />
                ...
                <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black/90 to-transparent p-3 h-[50%] flex flex-col justify-end space-y-2">
                    <p className="font-medium text-white line-clamp-3">{story.heading}</p>
            ...
            <div className="absolute left-2 lg:left-1/3">
                <div onClick={prevStory} className="lg:bg-white lg:dark:bg-[#171717] lg:rounded-full lg:p-3 lg:shadow-md cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" className="size-6 text-white lg:dark:text-white lg:text-black" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
            ...
            <div className="absolute right-2 lg:right-1/3">
                <div onClick={nextStory} className="lg:bg-white lg:dark:bg-[#171717] lg:rounded-full lg:p-3 lg:shadow-md cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" className="size-6 text-white lg:dark:text-white lg:text-black" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
