            ...
            <div className="space-y-10">
                ...
                <div className="rounded-xl border border-gray-300 dark:border-[#2E2E2E] overflow-hidden h-[720px]">
                    ...
                    <ul className="divide-y divide-gray-200 dark:divide-[#2E2E2E] bg-white dark:bg-[#171717] overflow-y-auto scrollbar-thin-yellow">
                        {[
                            ...
                            "Popular Maruti Nexa Cars In India",
                            "Popular Hyundai Cars In India",
                            "Popular Kia Cars In India",
                            "Popular Mahindra Cars In India",
                            "Popular Maruti Arena Cars In India",
                            "Popular Toyota Cars In India",
                ...
                <div className="h-[648px] bg-[#D9D9D9] dark:bg-[#262626] flex justify-center items-center">
                    <img
                        src={"/upcoming/ad.png"}
                        alt="ad image"
                        className="rounded-xl w-[302px] h-[600px] object-cover"
                    />
                </div>
