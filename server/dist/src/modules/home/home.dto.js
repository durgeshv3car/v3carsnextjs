...
export const quickLookQueryDto = paginationQuery.merge(z.object({
    type: z.enum(['popular', 'latest']).default('popular'),
}));
export const bodyTypeQueryDto = paginationQuery.merge(z.object({
...
export const priceQueryDto = paginationQuery.merge(z.object({
