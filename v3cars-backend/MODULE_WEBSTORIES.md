...
- Fields per group: `storyId`, `title`, `slug`, `authorId`, `status`, `createdAt`, `items[]`.
- Fields per item: `id`, `subStoryId`, `title`, `slug`, `contentSlug`, `authorId`, `addedBy`, `status`, `createdAt`, `updatedAt`.
