...
import TopBrandsSkeleton from "../ui/skeleton/TopBrandsSkeleton";
...
function TopBrands() {
    ...
    return (
        <div className="rounded-xl bg-white dark:bg-[#171717] border border-gray-300 dark:border-[#262626] overflow-hidden p-3 space-y-4 flex flex-col ">
            <div className="font-bold text-lg">Top Brands</div>

            <div className="grid grid-cols-2 gap-2 flex-grow">
                {brands.length > 0 ? brands.slice(0, 10).map((brand, i) => (
                    <div
                        key={i}
