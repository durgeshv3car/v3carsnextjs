                    ...
                    <div className="w-1/3 border-r dark:border-[#2E2E2E] overflow-y-auto">
                        <ul className="text-sm">
                            <li
                                ...
                                className={`p-4 ${showFilter === "Range" || showFilter === "Filter"
                            ...
                            <li
                                ...
                                className={`p-4 ${showFilter === "Brand"
                                        ? "bg-primary-light text-black font-semibold"
                                        : ""
                                    }`}
                            >
                            ...
                            <li
                                ...
                                className={`p-4 ${showFilter === "Transmission"
                                        ? "bg-primary-light text-black font-semibold"
                                        : ""
                                    }`}
                            >
                            ...
                            <li
                                ...
                                className={`p-4 ${showFilter === "Mileage"
                                        ? "bg-primary-light text-black font-semibold"
                                        : ""
                                    }`}
                            >
                            ...
                            <li
                                ...
                                className={`p-4 flex justify-between items-center ${showOthers
                                        ? "bg-primary-light text-black font-semibold"
                                        : ""
                                    }`}
                            >
                                ...
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className={`size-4 transition-transform ${showOthers ? "rotate-180" : ""
                                        }`}
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                    fill="none"
                            ...
                            {showOthers && (
                                <div className="bg-slate-100 dark:bg-[#171717] divide-y dark:divide-[#2E2E2E]">
                                    <div
                                        className={`p-4 ${showFilter === "cylinders"
                                                ? "bg-primary-light text-black font-semibold"
                                                : ""
                                            }`}
                                    ...
                                    <div
                                        className={`p-4 ${showFilter === "seating"
                                                ? "bg-primary-light text-black font-semibold"
                                                : ""
                                            }`}
                                    ...
                                    <div
                                        className={`p-4 ${showFilter === "engine"
                                                ? "bg-primary-light text-black font-semibold"
                                                : ""
                                            }`}
