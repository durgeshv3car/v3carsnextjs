...
import CarNewsCard from '../car-news/CarNewsCard';
import CarNewsSection from '../car-news/CarNewsSection';
...
export default function MainAutoExpoComponent() {
    ...
    return (
        <div>
            ...
            {todayAutoExpo !== null ? (
                <CarNewsCard data={todayAutoExpo} />
            ) : (
