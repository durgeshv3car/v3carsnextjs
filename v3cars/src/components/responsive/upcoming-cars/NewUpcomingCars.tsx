...
export default function NewUpcomingCars() {
    const { data: upcomingData } = useGetUpcomingCarsQuery();
        ...
        <>
            ...
            <div className='p-2 bg-[#FFFFFF] dark:bg-[#27262B] border border-[#DEE2E6] dark:border-[#2E2E2E] rounded-xl'>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {upcomingCars.length > 0 ? upcomingCars.map((car, idx) => (
                        <div
                            key={idx}
                ...
                <Link
                    href={"#"}
                    className="text-blue-500 hover:underline font-semibold p-2 pb-0 flex items-center gap-2 w-fit"
                >
