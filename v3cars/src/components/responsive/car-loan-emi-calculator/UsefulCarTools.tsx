...
export default function UsefulCarTools() {
    const tools = [
        "Mileage Calculator",
    ...
    return (
        <div className="w-[320px] border rounded-xl overflow-hidden dark:border-[#2e2e2e]">
            {/* Header */}
            ...
            <div className="max-h-[360px] overflow-y-auto scrollbar-thin-yellow bg-white dark:bg-[#171717]">
                {tools.map((item, index) => (
                    <div
                        key={index}
                        className="group flex items-center gap-3 p-4 border-b last:border-none hover:text-primary dark:border-[#2e2e2e]"
                    >
                        <Image
