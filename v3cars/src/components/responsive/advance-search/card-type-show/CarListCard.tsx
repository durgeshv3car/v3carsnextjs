...
import { FRONTEND_URL, IMAGE_URL2 } from "@/utils/constant";
            ...
            <div className="w-full flex flex-col flex-shrink">
                ...
                <div className="mt-2 flex flex-col lg:flex-row gap-4 justify-between border-t dark:border-[#2E2E2E] h-full flex-grow py-3 lg:py-0">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            className="bg-primary text-black text-sm font-medium w-full lg:w-[150px] h-10 rounded-md"
                            onClick={() => { router.push(`${FRONTEND_URL}/${car.brand.slug}/${car.modelSlug}/price-in-${convertToSlug(selectedCity.cityName)}`) }}
                        >
                            Get On Road Price
                        </button>
                    </div>
