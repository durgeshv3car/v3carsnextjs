...
export default function StatePage({ type, fuelType }: PageProps) {
    ...
    const stateByMetroCity: CityFuelLatestPrice[] = stateByMetroCityData?.rows ?? [];
        ...
        <>
                    ...
                    <div className="w-full lg:app-container mx-auto text-sm h-[42px] flex items-center justify-between gap-2">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-medium text-primary">
                                {capitalize(fuelType) ?? "Fuel"} Price In {convertToName(type)}
                            </span>
                        </div>
            ...
            <div className="relative mb-[300px] sm:mb-[170px] lg:mb-14">
                <div className="absolute -top-12 left-0 w-full px-4 lg:px-10">
                    <div className="w-full lg:app-container mx-auto">
                        <PriceInputSection type={capitalize(fuelType)} city={null} state={type} setCityId={setCityId} cityId={null} selectState={selectState} setSelectState={setSelectState} />
                    </div>
                </div>
            </div>
            ...
            <div className="px-4 xl:px-10">
                <div className="w-full lg:app-container py-6 mx-auto space-y-7">
                    ...
                    <div>
                        <div className="mb-4">
                            <h2 className="text-2xl mb-2 capitalize">{fuelType} Prices In {convertToName(type)}</h2>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            {stateByMetroCity.length > 0 ? stateByMetroCity.map((item) => (
                                <FuelPrices
                                    key={item.cityName}
                                    type={fuelType}
                                    city={item.cityName}
